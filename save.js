...
function save() {
  localStorage.setItem("inc-tourn-sigma-test", JSON.stringify(game));
}

function load() {
  if (localStorage.getItem("inc-tourn-sigma-test")) {
    savegame = JSON.parse(localStorage.getItem("inc-tourn-sigma-test"));
